...
if (typeof renderTwitters != 'function') (function () {
                                          ...
                                          return t.replace(/(^|[^&\w'"]+)\#([a-zA-Z0-9_]+)/g, function(m, m1, m2) {
                                                                ...
                                                                if (typeof options.twitterTarget == 'object')
                                                                var target = options.twitterTarget;
                                                                else
                                                                ...
                                                                ready((function(options, guid) {
                                                                       ...
                                                                       if ((typeof target != 'object') && !(target = document.getElementById(options.twitterTarget))) {
                                                                       $log.info('twitterTarget is undefined (' + typeof target + ')');
                                                                       return;
                                                                       }
                                                                       
                                                                       var url = 'http://api.twitter.com/1/statuses/user_timeline.json?screen_name=' + id + '&callback=twitterCallback' + guid + '&count=20&cb=' + Math.random();
                                                                       //'http://www.twitter.com/statuses/' + (options.withFriends ? 'friends_timeline' : 'user_timeline') + '/' + id + '.json?callback=twitterCallback' + guid + '&count=20&cb=' + Math.random();
                                                                       
                                                                       if (options.timeout) {
                                                                       window['twitterTimeout' + guid] = setTimeout(function () {
                                                                                                                    // cancel callback
                                                                                                                    if (options.onTimeoutCancel) window['twitterCallback' + guid] = function () {};
                                                                                                                    options.onTimeout.call(document.getElementById(target));
                                                                ...
                                                                date = new Date(parsed_date-offset);
